...
var PageLayer = function (_a) {
    ...
    return (React__namespace.createElement("div", { id:"testInner-"+pageIndex,className: "rpv-core__page-layer", "data-testid": "core__page-layer-".concat(pageIndex), ref: measureRef, style: {
            height: "".concat(h, "px"),
            width: "".concat(w, "px"),
...
var Inner = function (_a) {
    var currentFile = _a.currentFile, defaultScale = _a.defaultScale, doc = _a.doc, initialPage = _a.initialPage, initialRotation = _a.initialRotation, pageSize = _a.pageSize, plugins = _a.plugins, renderPage = _a.renderPage, scrollMode = _a.scrollMode, viewerState = _a.viewerState, onDocumentLoad = _a.onDocumentLoad, onOpenFile = _a.onOpenFile, onPageChange = _a.onPageChange, onRotate = _a.onRotate, onRotatePage = _a.onRotatePage, onZoom = _a.onZoom;
    var numPages = doc.numPages;
    var docId = doc.loadingTask.docId;
...
var Viewer = function (_a) {
    var characterMap = _a.characterMap, defaultScale = _a.defaultScale, fileUrl = _a.fileUrl, _b = _a.httpHeaders, httpHeaders = _b === void 0 ? {} : _b, _c = _a.initialPage, initialPage = _c === void 0 ? 0 : _c, _d = _a.initialRotation, initialRotation = _d === void 0 ? 0 : _d, localization = _a.localization, _e = _a.plugins, plugins = _e === void 0 ? [] : _e, renderError = _a.renderError, renderPage = _a.renderPage, renderLoader = _a.renderLoader, _f = _a.scrollMode, scrollMode = _f === void 0 ? exports.ScrollMode.Vertical : _f, transformGetDocumentParams = _a.transformGetDocumentParams, _g = _a.theme, theme = _g === void 0 ? {
        direction: exports.TextDirection.LeftToRight,
        theme: 'light',
    } : _g, _h = _a.withCredentials, withCredentials = _h === void 0 ? false : _h, onDocumentAskPassword = _a.onDocumentAskPassword, _j = _a.onDocumentLoad, onDocumentLoad = _j === void 0 ? function () {
    } : _j, _k = _a.onPageChange, onPageChange = _k === void 0 ? function () {
    } : _k, _l = _a.onRotate, onRotate = _l === void 0 ? function () {
    } : _l, _m = _a.onRotatePage, onRotatePage = _m === void 0 ? function () {
    } : _m, _o = _a.onSwitchTheme, onSwitchTheme = _o === void 0 ? function () {
    } : _o, _p = _a.onZoom, onZoom = _p === void 0 ? function () {
    } : _p;
    var _q = React__namespace.useState({
        data: fileUrl,
        name: typeof fileUrl === 'string' ? fileUrl : '',
        shouldLoad: false,
    }), file = _q[0], setFile = _q[1];
    ...
    var _r = React__namespace.useState(false), visible = _r[0], setVisible = _r[1];
    ...
    var _s = React__namespace.useState(localization || DefaultLocalization), l10n = _s[0], setL10n = _s[1];
        ...
        React__namespace.createElement(ThemeContext.Provider, { value: themeContext },
            React__namespace.createElement("div", { ref: containerRef, className: "rpv-core__viewer rpv-core__viewer--".concat(themeContext.currentTheme), "data-testid": "core__viewer", style: {
                    ...
                    width: '100%',
                            ...
                            data: file.data,
                            name: file.name,
                        }, defaultScale: defaultScale, doc: doc, initialPage: initialPage, initialRotation: initialRotation, pageSize: ps, plugins: plugins, renderPage: renderPage, scrollMode: scrollMode, viewerState: {
                            file: file,
                            pageIndex: -1,
