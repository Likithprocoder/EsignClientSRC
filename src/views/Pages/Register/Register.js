...
fetch(window.location.href)
  ...
  getSubgrpForThatcorp = (event) => {
    if (event.target.value !== '') {
      ...
      this.setState({ selectedCorpEnty: corpId });
      var json = {
        corpId: corpId
      };
  ...
  addCorpDetails = (event) => {
    ...
    if (document.getElementById("corpUsrID").value === '' || document.getElementById("corpEntyDrpdown").value === '') {
      if (document.getElementById("corpUsrID").value === '') {
        confirmAlert({
          ...
          overlayClassName: "voucher-confirm-overlay",
          buttons: [
            {
              label: "OK",
              className: "confirmBtn",
        ...
        confirmAlert({
          closeOnClickOutside: false,
          message: "Please select your corporate!",
          overlayClassName: "voucher-confirm-overlay",
          buttons: [
            {
              label: "OK",
    ...
    else if (document.getElementById("typeOfReqVoucher").checked && document.getElementById("EnteredVoucherCode").value.trim() == "") {
      confirmAlert({
        closeOnClickOutside: false,
      ...
      if (canProceed == true) {
        ...
        if (document.getElementById("typeOfReqVoucher").checked) {
          ...
          corpEntity.voucherCode = this.state.VoucherCode;
          delete corpEntity.requestedGrps;
        }
        ...
        this.setState({
          ...
          corpUserId: document.getElementById("corpUsrID").value
        })
            ...
            <>
              ...
              <div key="usrCrpIdBody" className='Divo5Css'>
                ...
                <div className='inputname1'>
                  <input type="text" name="Corporate user id" value={this.state.corpUserId} onChange={this.showHiddenTypeOfReq} id="corpUsrID" placeholder="Please enter the corp ID" autoCapitalize='off' className='inputCss' />
                </div>
              </div>
              ...
              <div key="corpList" className='Divo5Css'>
                ...
                <div className='inputname1'>
                  <select className='inputCss' id="corpEntyDrpdown" onChange={e => this.getSubgrpForThatcorp(e)} value={this.state.selectedCorpEnty} >
              ...
              <div id="checkBoxDiffMode" hidden={this.state.selectedCorpEnty == ""}>
                <input type="radio" id="typeOfReqGroups" name="typeOfReq" value="Groups" checked={this.state.checkBoxGrp} onChange={this.showHiddenTypeOfReq} />
                <label htmlFor="typeOfReqGroups">Groups</label>

                <input type="radio" id="typeOfReqVoucher" name="typeOfReq" value="Voucher" checked={this.state.checkBoxVoucher} onChange={this.showHiddenTypeOfReq} />
                <label htmlFor="typeOfReqVoucher">Voucher</label>
              </div>
              ...
              <div key="corpGroups" id="corpGroups" className='Divo5Css' hidden={!this.state.checkBoxGrp}>
                <div className='InputName'>
                  <span>Groups</span>
                </div>
              ...
              <div key="usrCrpIdBody" id="corpVoucher" className='Divo5Css' hidden={!this.state.checkBoxVoucher}>
                <div className='InputName'>
                  <span>Voucher Code </span>
                </div>
                <div className='inputname1'>
                  <input type="text"
                    name="EnteredVoucherCode" id="EnteredVoucherCode"
                    placeholder="Enter voucher code" autoCapitalize='off'
  ...
  setVoucherCode = (e) => {
    ...
    this.setState({ VoucherCode: filteredValue });

  }

  showHiddenTypeOfReq = (event) => {
    const selectedValue = event.target.value;
    if (selectedValue === "Groups") {
      this.setState({ checkBoxGrp: true, checkBoxVoucher: false });

      document.getElementById("corpGroups").hidden = false;
      document.getElementById("corpVoucher").hidden = true;
    } else if (selectedValue === "Voucher") {
      this.setState({ checkBoxVoucher: true, checkBoxGrp: false })

      document.getElementById("corpVoucher").hidden = false;
      document.getElementById("corpGroups").hidden = true;
    }



    if (event.target.id == "corpUsrID") {
      this.setState({ corpUserId: event.target.value })
    }
